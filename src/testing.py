...
try:
    while True:
        try:
            ...
            cv2.imwrite(f'/home/mrw4/workspaces/lost-tools/data/sample_inputs/streamed_frames_02/left/left_{frame_id:06d}.jpg', left_frame_bgr)
            cv2.imwrite(f'/home/mrw4/workspaces/lost-tools/data/sample_inputs/streamed_frames_02/right/right_{frame_id:06d}.jpg', right_frame_bgr)
            with open(f'/home/mrw4/workspaces/lost-tools/data/sample_inputs/streamed_frames_02/metadata/frame_{frame_id:06d}.json', 'w', encoding='utf-8') as file:
