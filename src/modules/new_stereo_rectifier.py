...
class StereoRectifier:
    ...
    def rectify_pair(self, left_frame, right_frame):
        ...
        right_frame may be None on frames that skip the depth stack; the left
        frame still has to be rectified so the tracker sees a consistent image
        every frame.
        """
        ...
        if right_frame is None:
            return left_rect.transpose(2, 0, 1), None
